    ...
    <div class="">
        <nav class="breadcrumb1" aria-label="breadcrumb">
            <ol class="breadcrumb font_size">
                ...
                <li class="breadcrumb-item font_size active" aria-current="page">Privacy and Policy</li>
                    ...
                    <div class="row">
                        <div class="col-xl-12 col-lg-8 mb-5">
                            <div class="project-details__content-left">
                                ...
                                <b>D. Personal Characteristics</b>
                                <ul>
                                    <li>Age</li>
                                    <li>Gender</li>
                                    <li>Date of Birth</li>
                                ...
                                <b>F. Education and Recruitment Data</b>
                                <ul>
                                    <li>Educational qualification</li>
                                    <li>Working goals</li>
                                    <li>Post-qualification experience</li>
                                </ul>
                                <b>G. Electronic Identification Data</b>
                                <ul>
                                ...
                                <ul>
                                    ...
                                    <li>Nformation about your interactions with customer service and maintenance interactions with us.</li>
                                </ul>
                                <b>I. User Generated Data</b>
                                <ul>
                                ...
                                <P class="project-details__text-1">We do not collect any payments information processed by third-party payment gateway providers.</P>
                                <h3 class="project-details__title-1">5. Special Categories of Personal Data</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <h3 class="project-details__title-1">What types of cookies do we use?</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <h3 class="project-details__title-1">How to manage cookies?</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <h3 class="project-details__title-1">8. Data Analytics</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <br> <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                If you do not wish to have data relating to your visits to our websites collected through Google Analytics, you may opt-out by installing the Google Analytics opt-out browser add-on. You may opt-out of Facebook Custom Audiences by visiting Facebook’s opt-out page.</p>

                                <h3 class="project-details__title-1">9. Aggregated Data</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <h3 class="project-details__title-1">10. Data protection principles</h3>
                                ...
                                <ul>
                                    ...
                                    <li>be processed in a manner that ensures appropriate security of Personal Data including protection against unauthorised or unlawful</li>
                                    <li>be processed in a manner that ensures appropriate security of Personal Data including protection against unauthorised or unlawful processing, accidental loss, destruction or damage by using appropriate technical or organisation measure</li>
                                    <li>comply with the relevant laws and procedures for international transferring of Personal Data applicable to us.</li>
                                </ul>
                                
                                 <h3 class="project-details__title-1">11. Legal basis for processing your Personal Data</h3>
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 ...
                                 <h3 class="project-details__title-1">12. Legal basis for processing your Personal Data</h3>
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 ...
                                 <h3 class="project-details__title-1">13. Purpose of collecting Personal Data</h3>
                                 ...
                                 <h3 class="project-details__title-1">14. Advertising and Marketing</h3>
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 ...
                                 <h3 class="project-details__title-1">16. Disclosure of Personal Data</h3>
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 ...
                                 <br><i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 You may have the right to complain to a data protection authority about our processing of your Personal Data. For more information, please contact your local data protection authority.</p>

                                 <h3 class="project-details__title-1">17. Our Policy on Children’s Data</h3>
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 ...
                                 <br><i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 As a general policy, our company does not engage in the collection, processing, storage, use, dissemination, and transfer of Personal Data of children In case such a collection becomes necessary for the performance of our contractual obligations, or when required under the concerned law, we shall notify you in a time-bound and appropriate manner, informing the purposes and reasons for such collection and seek your explicit consent, and where applicable, parental authorization, prior to the processing of such data.
                                 <br><i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 We will take appropriate steps to delete any Personal Data of children’s that has been collected on our website without verified parental consent upon learning of the existence of such Personal Data, subject to conditions stipulated in the laws of applicable jurisdiction.</p>
                                 ...
                                 <p class="project-details__text-1">
                                 <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                 Personal Data should not be kept or transported on laptops, USB sticks, or similar devices, unless authorised by [insert details]. Where Personal Data is recorded on any such device it should be protected by:</p>
                                 <ul>
                                ...
                                <h3 class="project-details__title-1">20. Our Policy on Children’s Data</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <br><i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                Where there is likely to be a high risk to individuals rights and freedoms due to a processing activity, we will first undertake a Data Protection Impact Assessment (DPIA) and consult with the relevant supervisory authority prior to processing, if necessary.</p>


                                <h3 class="project-details__title-1">22. Conflicts of Law</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                This Policy is intended to comply with the laws and regulations in the place of establishment and of the countries in which company operates. In the event of any conflict between this Policy and applicable laws and regulations, the latter shall prevail.</p>

                                <h3 class="project-details__title-1">23. Retention of Personal Data</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                                ...
                                <h3 class="project-details__title-1">24. Procedures</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                               ...
                               <ul>
                                   <li>it appoints or employs employees with specific responsibilities for: o the processing and controlling of data</li>
                               </ul>
                                <p class="project-details__text-1">
                                ...
                                <h3 class="project-details__title-1">25. Breach notification</h3>
                                <p class="project-details__text-1">
                                <i class="fa fa-hand-point-right" style="margin-right:5px; color:grey;"></i>
                               ...
                               <table class="table table-bordered">
                                ...
                                <tbody>
                                 ...
                                 <tr>
                                  <td>Protected classification characteristics under California or federal law.
                                  </td>
                                 ...
                                 <tr>
                                     ...
                                     <td>Genetic, physiological, behavioural, and biological characteristics, or activity patterns used to extract a template or other identifier or identifying information, such as, fingerprints, faceprints, and voiceprints, iris or retina scans,</td>
                                 </tr>
                                 <tr>
                                     <td></td>
                                     <td>keystroke, gait, or other physical patterns, and sleep, health, or exercise data.</td>
                                 </tr>
                                 <tr>
